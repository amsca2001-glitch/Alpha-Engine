  ...
  try {
    ...
    const response = await fetch("https://api.anthropic.com/v1/messages", {
      ...
      body: JSON.stringify({
        ...
        messages: [{ role: "user", content: `Search Yahoo Finance for the current share price of ${ticker} right now. Then analyze this hospitality stock using real data from SEC filings and earnings releases. Return ONLY clean JSON, no cite tags.` }]
      })
    });
